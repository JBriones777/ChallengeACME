...
public class RegisterContractCourseFailedXAmountInsufficient : BaseTest
{
    ...
    protected override void When()
    {
        try
        {
            _contractCourse = _contractCourseService.ContractCourse(_student.Id, _course.Id, 49);
        }
        catch (Exception ex)
        {
            _exception = ex;
    ...
    public void Then_Failed()
    {
        ...
        _exception.Message.Should().Be("The amount paid is less than the course fee");
    }
}
